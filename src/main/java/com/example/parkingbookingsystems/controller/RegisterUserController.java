...
public class RegisterUserController {
    ...
    public void registerButton() {
        ...
        if (register_email.getText().isEmpty() || register_username.getText().isEmpty() || register_password.getText().isEmpty()) {
            ...
            String sqlGetMaxId = "SELECT MAX(user_id) FROM [User]";
            String sqlAdmin = "INSERT INTO [User] (user_id, firstName, lastName, email, phoneNumber) VALUES (?, ?, ?, ?, ?)";
            String sqlCredentials = "INSERT INTO UserCredentials (user_id, username, password) VALUES (?, ?, ?)";
